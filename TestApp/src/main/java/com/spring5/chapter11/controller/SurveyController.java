...
import com.spring5.chapter11.model.Question;
import com.spring5.chapter11.survey.AnsweredData;
...
public class SurveyController {
    ...
    private List<Question> createQuestions() {
        ...
        Question q2 = new Question("많이 사용하는 개발도구는 무엇입니까?", Arrays.asList("이클립스", "인텔리제이", "비주얼스튜디오"));
